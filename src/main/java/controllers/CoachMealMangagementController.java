...
//                "    -fx-background-radius: 30;");
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        try {
            ...
            System.out.println("waaaaaaaaaaaaaak"+userService.getAll());
    ...
    void AddToClient(ActionEvent event) {
        try {
            chosenUser = userService.getAll().stream().filter(user -> user.getNom().equals(usersList.getValue())).findFirst().orElse(null);
