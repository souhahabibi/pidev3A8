...
public class Meal {
    ...
    private ObservableList<UsersMeal> usersMeals = FXCollections.observableArrayList();

    // Other methods...

    public ObservableList<UsersMeal> getUsersMeals() {
        return usersMeals;
    }

    public void setUsersMeals(ObservableList<UsersMeal> usersMeals) {
        this.usersMeals = usersMeals;
    }
