...
public class MaterielService implements IService<Materiel> {
    ...
    @Override
    public void insererImage(Materiel materiel) {

    }

    @Override
    public void ajoutercom(Materiel materiel) {
    ...
    @Override
    public ObservableList<Materiel> getAll() {
        return null;
    }
    ...
    @Override
    public boolean find(Materiel materiel) {
        return false;
    }

    @Override
    public Materiel findOne(Materiel entity) {
        return null;
    }
