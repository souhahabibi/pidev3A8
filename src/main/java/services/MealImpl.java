...
public class MealImpl implements IMealService {
    ...
    public MealImpl() {
        ...
        ingredient = (IIngredientService) new IngredientImpl();
    }
    ...
    @Override
    public List<Meal> recuperer() throws SQLException {
        return null;
    }
    ...
    @Override
    public void insererImage(Meal meal) {

    }

    @Override
    public void ajoutercom(Meal meal) {
