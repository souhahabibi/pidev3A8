...
public class ServiceFournisseur implements IService<Fournisseur> {
    ...
    @Override
    public void insererImage(Fournisseur fournisseur) {

    }

    @Override
    public void ajoutercom(Fournisseur fournisseur) {
    ...
    @Override
    public boolean find(Fournisseur fournisseur) {
        return false;
    }

    @Override
    public Fournisseur findOne(Fournisseur entity) {
        return null;
    }
