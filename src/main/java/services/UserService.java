...
public class UserService implements IService<User> {
    ...
    @Override
    public void insererImage(User user) {

    }

    @Override
    public void ajoutercom(User user) {
    ...
    public ObservableList<User> getAll() {
       ...
       // User user = null;
        ...
        System.out.println("sla7777777"+users);
    ...
    public User getById(int id) {
        String req = "select * from user where role='client' and id=?";
        User user = null;
        try {
